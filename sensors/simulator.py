...
while True:
    ...
    now_volume = int(input('Введите объем воды, который находится в баке (не выше максимального порога и не ниже 0): '))

    if 0 <= now_volume <= sensor_high.value:
        print("Текущий объем воды условно определен.")
        break
    else:
        print("Значение объема воды должно быть не выше максимального порога!")
        pass
